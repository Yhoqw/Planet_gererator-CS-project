...
void generateRaces(string raceList[], int &raceCount);
void displayPlanet(const string &name, const string &atmosphere, const string &size, const string history[], int eventCount, const string raceList[], int raceCount);
void save_planet_file(const string &name, const string &atmosphere, const string &size, const string history[], int eventCount, const string raceList[], int raceCount);
...
int main() 
{
    ...
    do 
	{
        ...
        cout << "2. Explore an older Planet from File" << endl;
		...
		{	
			...
			{	
                ...
                int raceCount = 0;
                generateRaces(planetRaces, raceCount);

                // Display and save the planet (using functions)
                displayPlanet(planetName, planetAtmosphere, planetSize, planetHistory, historyEventCount, planetRaces, raceCount);
                save_planet_file(planetName, planetAtmosphere, planetSize, planetHistory, historyEventCount, planetRaces, raceCount);
                break;
            }
...
void load_planet_file() 
{
	...
	if (inFile.is_open()) 
	{
        ...
        displayPlanet(name, atmosphere, size, history, eventCount, raceList, raceCount);
    }
